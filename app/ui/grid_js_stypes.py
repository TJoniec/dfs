...
RANK_DIFFERENCE_ROW_CLASSES = {
    ...
    "row-better": "params.data && (params.data.AdjustedFPTS_Rank*1 - params.data.ProjectedFPTS_Rank*1) <= - 4",

    # fantasyPointsRank exceeds FPTS_Rank by > 4
    "row-worse":  "params.data && (params.data.AdjustedFPTS_Rank*1 - params.data.ProjectedFPTS_Rank*1)  > 4",
}
